...
func TestMarshalAIDiagnoseComplete(t *testing.T) {
	...
	raw, err := marshalAIDiagnoseComplete(resultsDir, reportPath, rep)
	require.NoError(t, err)
...
func TestMarshalAIDiagnoseComplete_capsFindings(t *testing.T) {
	...
	raw, err := marshalAIDiagnoseComplete(t.TempDir(), "report.json", rep)
	require.NoError(t, err)
...
func TestRenderDiagnoseArtifactsTable(t *testing.T) {
	...
	plain := stripANSI(renderDiagnoseArtifactsTable(results, report, csv))
...
func TestRenderDiagnoseArtifactsTable_noCSV(t *testing.T) {
	t.Parallel()
	plain := stripANSI(renderDiagnoseArtifactsTable("/tmp/out", "/tmp/out/report.json", ""))
	assert.Contains(t, plain, "results")
	assert.Contains(t, plain, "report")
...
func TestPrintDiagnoseArtifactsFooter_table(t *testing.T) {
	...
	printDiagnoseArtifactsFooter(out, "/tmp/out", "/tmp/out/report.json", "/tmp/out/report.csv")
